...
The easiest way to use **cytofkit2** package is through the ShinyApp. The GUI provides all main options of **cytofkit** on a visual interface. To launch the GUI, load the package and type the following command:
